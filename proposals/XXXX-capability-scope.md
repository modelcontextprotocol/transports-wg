...
When a client sends per-request capabilities (as defined in SEP-2575),
...
No schema changes beyond those in SEP-2575 are required.  This proposal
...
with SEP-2575's stateless design, each request is self-contained.  The
...
servers interpret the `clientCapabilities` field that SEP-2575
introduces.
