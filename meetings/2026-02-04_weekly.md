...
## Action Items
- [ ] **Mark Roth** to update the MRTR SEP to clarify the differences between
  ephemeral and persistent cases, focusing specifically on message patterns.
- [ ] **Mark Roth** and **Caitie McCaffrey** to incorporate the agreed-upon
  ...
  SEP.
- [ ] **Mark Roth** to lead the discussion on the State SEP (1685) and check in
  on other in-flight SEPs at the next meeting.